    ...
    with torch.no_grad():
        ...
        for kg_batch in tqdm(list(chunks(input_graph, batch_size))):
            ...
            for kg_input in kg_batch:
                queries.append("{} {} [GEN]".format(kg_input.head, kg_input.relation))
...
def main():
    ...
    kg_graph = random.sample(population=kg_graph, k=150)
    ...
    print(
        "Comet-BART generations saved at {}.jsonl and {}.json".format(
            args.cometbart_output_path, args.cometbart_output_path
        )
    )
